    ...
    public static void minionInit()
    {
        ...
        Minions.add(new Minion("Persian Archer" , "Minion_1" , 2 ,300 ,
                ...
                new Spell("NoName" , "1000" , 1,0,"NoDesc",
                        TargetSocietyKind.FRIENDLY_CARDS,SpellName.POWER_UP, ActivationCondition.PASSIVE,new ArrayList<Buff>())));
        ...
        Minions.add(new Minion("Persian Swordsman" , "Minion_2" , 2 ,400 ,
                ...
                AttackKind.MELEE,
                new Spell("NoName" , "1000" , 1,0,"NoDesc",
                        TargetSocietyKind.ENEMY_CARDS,SpellName.ALL_POISON, ActivationCondition.ATTACK,new ArrayList<Buff>())));
        ...
        Minions.add(new Minion("Persian Pahlavan" , "Minion_5" , 9 ,600 ,
                ...
                AttackKind.MELEE,
                new Spell("NoName" , "1000" , 1,0,"NoDesc",
                        TargetSocietyKind.ENEMY_CARDS,SpellName.POWER_UP, ActivationCondition.ATTACK,new ArrayList<Buff>())));
        ...
        Minions.add(new Minion("OneEyed Giant" , "Minion_17" , 7 ,500 ,
                ...
                AttackKind.HYBRID,
                new Spell("NoName" , "1000" , 1,0,"NoDesc",
                        TargetSocietyKind.ENEMY_CARDS,SpellName.POWER_UP, ActivationCondition.DEATH,new ArrayList<Buff>())));
        ...
        Minions.add(new Minion("Wild Lion" , "Minion_20" , 2 ,600 ,
                "Holy buff has no effect on him" , MinionName.SHIRE_DARANDE,
                1,8,1,
                AttackKind.MELEE,
                new Spell("NoName" , "1000" , 1,0,"NoDesc",
                        TargetSocietyKind.ENEMY_CARDS,SpellName.POWER_UP, ActivationCondition.ATTACK,new ArrayList<Buff>())));
        ...
        Minions.add(new Minion("Giant Snake" , "Minion_21" , 8 ,500 ,
                ...
                AttackKind.RANGED,
                new Spell("NoName" , "1000" , 1,0,"NoDesc",
                        TargetSocietyKind.ENEMY_CARDS,SpellName.POWER_UP, ActivationCondition.SPAWN,new ArrayList<Buff>())));
        ...
        Minions.add(new Minion("Gorg" , "Minion_24" , 3 ,400 ,
                ...
                AttackKind.MELEE,
                new Spell("NoName" , "1000" , 1,0,"NoDesc",
                        TargetSocietyKind.ENEMY_CARDS,SpellName.WEAKENING, ActivationCondition.ATTACK,new ArrayList<Buff>())));
        ...
        Minions.add(new Minion("Mage" , "Minion_25" , 4 ,550 ,
                ...
                AttackKind.RANGED,
                new Spell("NoName" , "1000" , 1,0,"NoDesc",
                        TargetSocietyKind.ENEMY_CARDS,SpellName.POWER_UP, ActivationCondition.PASSIVE,new ArrayList<Buff>())));
        ...
        Minions.add(new Minion("Archmage" , "Minion_26" , 6 ,550 ,
                ...
                AttackKind.RANGED,
                new Spell("NoName" , "1000" , 1,0,"NoDesc",
                        TargetSocietyKind.FRIENDLY_CARDS,SpellName.POWER_UP, ActivationCondition.ATTACK,new ArrayList<Buff>())));
        ...
        Minions.add(new Minion("Wild Boar" , "Minion_28" , 6 ,500 ,
                ...
                AttackKind.MELEE,
                new Spell("NoName" , "1000" , 1,0,"NoDesc",
                        TargetSocietyKind.FRIENDLY_CARDS,SpellName.POWER_UP, ActivationCondition.DEFEND,new ArrayList<Buff>())));
        ...
        Minions.add(new Minion("Piran" , "Minion_29" , 8 ,400 ,
                ...
                AttackKind.MELEE,
                new Spell("NoName" , "1000" , 1,0,"NoDesc",
                        TargetSocietyKind.FRIENDLY_CARDS,SpellName.POWER_UP, ActivationCondition.DEATH,new ArrayList<Buff>())));
        ...
        Minions.add(new Minion("Ashkboos" , "Minion_32" , 7 ,400 ,
                ...
                AttackKind.MELEE,
                new Spell("NoName" , "1000" , 1,0,"NoDesc",
                        TargetSocietyKind.ENEMY_CARDS,SpellName.POWER_UP, ActivationCondition.DEFEND,new ArrayList<Buff>())));
