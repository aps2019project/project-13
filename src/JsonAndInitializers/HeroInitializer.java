    ...
    public static void HeroInit()
    {
        ...
        heroes.add(new Hero("Simorq", "Hero_2",5 , 9000,
                ...
                new Spell("NoName" , "1001",1,0,"No" ,
                        TargetSocietyKind.ENEMY_CARDS,SpellName.ALL_DISARM, ActivationCondition.ATTACK,new ArrayList<Buff>()),
                8));
        ...
        heroes.add(new Hero(" Kaveh", "Hero_6",1 , 8000,
                ...
                50,4,1,
                new Spell("NoName" , "1000",1,0,"No" ,
                        TargetSocietyKind.CELL,SpellName.SACRIFICE, ActivationCondition.ATTACK,new ArrayList<Buff>()),
                3));
        ...
        heroes.add(new Hero("Afsaneh", "Hero_8",1 , 11000,
                ...
                40,3,3,
                new Spell("NoName" , "1000",1,0,"No" ,
                        TargetSocietyKind.ENEMY_CARDS,SpellName.DISPEL, ActivationCondition.ATTACK,new ArrayList<Buff>()),
                2));
        ...
        heroes2.add(new Hero("Esfandyar", "Hero_9",0 , 12000,
                ...
                35,3,3,
                new Spell("NoName" , "1000",1,0,"No" ,
                        TargetSocietyKind.FRIENDLY_CARDS,SpellName.ALL_DISARM, ActivationCondition.PASSIVE,new ArrayList<Buff>()),
                0));
